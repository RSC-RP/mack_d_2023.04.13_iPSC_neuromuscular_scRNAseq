...
```{r}
umi_counts_filt <-  sapply(as.data.frame(as.matrix(merged_norm_obj@assays$RNA@counts)), function(x) sum(x > 1))
...
if(!exists("merged_filt_obj")){
  merged_filt_obj <- readRDS("results/day0_day50/seurat/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_seurat_obj.RDS")
}
