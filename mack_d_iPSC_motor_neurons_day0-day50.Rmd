...
table(marker_genes_endoderm %in% rownames(merged_norm_obj))
# marker_genes_endoderm[!marker_genes_endoderm %in% rownames(merged_norm_obj)]
```
...
saveRDS(merged_norm_obj, 
        "results/day0_day50/seurat/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_normalized_seurat_obj_v5.RDS")
