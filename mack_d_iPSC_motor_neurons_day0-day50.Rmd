...
table(VariableFeatures(merged_norm_obj, assay = "SCT") %in% cc_genes$s.genes)
table(VariableFeatures(merged_norm_obj, assay = "SCT") %in% cc_genes$g2m.genes)
```

```{r fig.height=10, fig.width=10}
FeaturePlot(merged_norm_obj, reduction = "umap", features = "S.Score")
FeaturePlot(merged_norm_obj, reduction = "umap", features = "G2M.Score")
FeaturePlot(merged_norm_obj, reduction = "umap", features = "CC.Difference")
```
...
merged_norm_cc_obj <- AddMetaData(merged_norm_cc_obj,
                                   as.data.frame(merged_norm_cc_obj@reductions$umap@cell.embeddings))

    saveRDS(merged_norm_obj, glue("results/day0_day50/seurat/iPSC_MN_day0-day50_time-course_filtered_merged_soupX_normalized_cellcycle_seurat_obj_v5.RDS"))
