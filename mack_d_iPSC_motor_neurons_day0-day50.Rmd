...
ggplot(merged_obj@meta.data, aes(x = nCount_RNA)) +
  geom_histogram(binwidth = 500) +
  scale_x_continuous(breaks = seq(0, 5e5, by= 1e4)) +
  geom_vline(xintercept = c(lib_size_thr), color = "red") +
  theme(axis.text.x = element_text(angle = 35, vjust = 1, hjust = 1))

ggplot(merged_obj@meta.data, 
  ...
  geom_hline(yintercept = c(lib_size_thr, 30157), color = "red") +
  theme(axis.text.x = element_text(angle = 35, vjust = 1, hjust = 1))
...
ggplot(merged_obj@meta.data, 
  ...
  geom_point(aes(color = mt.threshold),
             alpha = 0.75, size = 0.5, position = position_jitter()) +
  geom_violin(fill = "blue", alpha = 0.2)  +
  geom_hline(yintercept = c(10461, 200), color = "red") +
  theme(axis.text.x = element_text(angle = 35, vjust = 1, hjust = 1))
# dev.off()
```
