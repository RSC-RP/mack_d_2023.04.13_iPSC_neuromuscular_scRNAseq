...
if(!exists("merged_norm_cc_obj")){
  merged_norm_cc_obj <- readRDS("results/day0_day50/seurat/iPSC_MN_day0-day50_time-course_filtered_merged_soupX_normalized_cellcycle_seurat_obj_v5.RDS")
}
