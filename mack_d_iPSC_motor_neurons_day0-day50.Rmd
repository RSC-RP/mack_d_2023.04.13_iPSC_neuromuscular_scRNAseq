...
purrr::map(c("umaprpca","umaprpcaorder"), function(x){
  ...
  png("figures/day0_day50/filtered_merged_rpca/iPSC_MN_seurat_{x}_UMAP_batch_filtered.png",  height = 15, width = 25, units = "in", res = 150)
  rpcafilt_batch
  dev.off()
  ...
  rpca_3d <- make_3D_umap(metadata = merged_rpca_obj@meta.data, 
             ...
             label_cols = c("id","batch"), 
             selected_colors = colors_vector)
  htmlwidgets::saveWidget(rpca_3d, "figures/day0_day50/filtered_merged_rpca/iPSC_MN_seurat_{x}_UMAP.html")
})
```
