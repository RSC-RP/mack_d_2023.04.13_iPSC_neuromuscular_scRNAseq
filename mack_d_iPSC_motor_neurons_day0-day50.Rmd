...
Objective metric - use the amount of "density" of day0 cells in their cluster, since day0 should be 100% homogeneous and fewer clusters/cells found in later time-points
...
merged_norm_obj[["SCT"]]@SCTModel.list <- merged_norm_obj[["SCT"]]@SCTModel.list[rev(names(merged_norm_obj[["SCT"]]@SCTModel.list))]
