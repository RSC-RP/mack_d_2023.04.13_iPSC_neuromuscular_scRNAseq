...
current_obj <- "iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_seurat_obj_v3.RDS" #v3 Seurat object
  #"iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_seurat_obj.RDS" #v5 Seurat Object
...
#  2 layers present: counts, data
merged_filt_obj 
# saveRDS(merged_filt_obj,"results/day0_day50/seurat/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_seurat_obj_v3.RDS")

table(merged_filt_obj@meta.data$time_point)
Layers(merged_filt_obj)
```
...
```{r}
merged_norm_obj <- readRDS("results/day0_day50/seurat/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_normalized_seurat_obj.RDS")
...
merged_harmony_obj[["RNA"]] <- split(merged_harmony_obj[["RNA"]], f = merged_harmony_obj$batch)
merged_harmony_obj
```
