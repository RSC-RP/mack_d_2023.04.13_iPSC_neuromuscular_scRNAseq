...
filt_b34_id <- custom_dimplot(metadata = merged_norm_obj@meta.data %>% 
                            filter(grepl("batch3|batch4", batch)),
                         colorby = "id", 
                         add_text = FALSE,
                         dimred_colnames = "umap", 
                         custom_colors = colors_vector)
...
if(!exists("merged_filt_obj_v3")){
  obj_path <- "results/day0_day50/seurat/intermediate_objects/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_normalized_seurat_obj_v3.RDS"
...
# Layers(merged_norm_obj, assay = "RNA")
# names(merged_norm_obj@assays$SCT@SCTModel.list)
...
# job::job({
#   saveRDS(merged_rpca_obj, "results/day0_day50/seurat/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_normalized_RPCAIntegration_seurat_obj_v5.RDS")
# }, import = c("merged_rpca_obj"))
```

```{r fig.height=10, fig.width=10}
# pdf("figures/day0_day50/filtered_merged_rpca/merged_rpca_sct_transform_100PCs_elbow_plot.pdf", height = 7, width=10)
...
# png("figures/day0_day50/filtered_merged_rpca/iPSC_MN_seurat_rpca_UMAP_day_filtered.png", height = 15, width = 25, units = "in", res = 150)
rpcafilt_id
# dev.off()
...
# png("figures/day0_day50/filtered_merged_rpca/iPSC_MN_seurat_rpca_UMAP_splitBy_batch_day_filtered.png",  height = 15, width = 25, units = "in", res = 150)
rpcafilt_b34_id + 
  facet_wrap(~time_point)
# dev.off()

# png("figures/day0_day50/filtered_merged_rpca/iPSC_MN_seurat_rpca_UMAP_batch_filtered.png",  height = 15, width = 25, units = "in", res = 150)
rpcafilt_batch
# dev.off()
```
...
# pdf("figures/day0_day50/filtered_merged_harmony/merged_harmony_obj_batch_byLouvainCluster_sct_UMAP.pdf",height = 10, width= 17)
DimPlot(merged_harmony_obj,
...
# png("figures/day0_day50/filtered_merged_harmony/merged_harmony_obj_iPSC_MN_seurat_UMAP_splitBy_batch_day_filtered.png",  height = 15, width = 25, units = "in", res = 150)
filt_b34_id + 
  facet_wrap(~time_point)
# dev.off()

# png("figures/day0_day50/filtered_merged_harmony/merged_harmony_obj_iPSC_MN_seurat_UMAP_day_filtered.png", height = 15, width = 25, units = "in", res = 150)
filt_id
# dev.off()

# png("figures/day0_day50/filtered_merged_harmony/merged_harmony_obj_iPSC_MN_seurat_UMAP_batch_filtered.png", height = 15, width = 25, units = "in", res = 150)
filt_batch
# dev.off()
```
