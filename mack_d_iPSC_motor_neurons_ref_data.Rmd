...
rpca_3d <- make_3D_umap(metadata = merged_split_obj@meta.data, 
             idents_column = c(paste0("umaprpca_",1:3), "subtype_standardized"), 
...
scanvi_3d <- make_3D_umap(metadata = merged_split_obj@meta.data, 
             idents_column = c(paste0("umapscanvi_",1:3), "subtype_standardized"), 
             extra_label_cols = c("subtype_standardized"), 
             selected_colors = colors_vector)

# htmlwidgets::saveWidget(rpca_3d, "figures/cell_refs/allen_yadav_rayon_integrated/embryonic_adult_sc_mc_integrated_rpca_UMAP.html")
# htmlwidgets::saveWidget(scanvi_3d, "figures/cell_refs/allen_yadav_rayon_integrated/embryonic_adult_sc_mc_integrated_scanvi_UMAP.html")
```
