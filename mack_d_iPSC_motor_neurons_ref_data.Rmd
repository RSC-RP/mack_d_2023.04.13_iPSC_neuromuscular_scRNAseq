...
SCT integration: <https://github.com/satijalab/seurat/issues/7542>

<https://github.com/satijalab/seurat/issues/7145> - You don't need to
worry about those warnings. We will fix them in Seurat-object package.
...
it looks like they string split the original IDs and did NOT provide the
actual donor IDs \>
...
#remove MT genes for consistency
...
library(sceasy)
library(anndata)
reticulate::use_condaenv(condaenv = file.path(Sys.getenv("HOME"), "opt/mambaforge/envs/scanvi"))
