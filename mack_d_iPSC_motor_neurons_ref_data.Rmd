...
# ref_motor_cortex
dim(ref_motor_cortex) #28271 76533
...
```{r}
ref_spinal_cord$donor <- ref_spinal_cord$sample
ref_motor_cortex$donor <- ref_motor_cortex$external_donor_name_label
```

```{r}
ref_spinal_cord <- split(ref_spinal_cord, f = ref_spinal_cord$donor)
ref_motor_cortex <- split(ref_motor_cortex, f = ref_motor_cortex$donor)
```
