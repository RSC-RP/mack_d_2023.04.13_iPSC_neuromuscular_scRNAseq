...
if(!exists("ref_spinal_cord")){
  ref_spinal_cord <- readRDS("resources/cell_refs/allen_institute/M1/human_M1_normalized_seurat_object.RDS")
}

if(!exists("ref_motor_cortex")){
  ref_motor_cortex <- readRDS("resources/cell_refs/Yadav_2023/GSE190442_aggregated_postqc_normalized_seurat_obj.RDS")
}
...
```{r}
table(embryonic_sc$Type_step1)
table(embryonic_sc$Type_step2)
```
...
embryonic_sc$donor <- embryonic_sc$orig.replicate
