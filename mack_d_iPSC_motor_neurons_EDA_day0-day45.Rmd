...
* iPSC_ipsc (day 0)
 ...
 - regardless of level of filtering
  ...
  outfile <- glue("figures/soupX/{x}_MarkerDistribution_figure.pdf")
    tryCatch(expr = {
       p <- plotMarkerDistribution(adj_sc)
       
    }, error = function(e){
      print(e)
      # print("cannot plot plotMarkerDistribution")
    })
    
    # pdf(outfile, height = 7, width = 10)
    print(p)
    # dev.off()
