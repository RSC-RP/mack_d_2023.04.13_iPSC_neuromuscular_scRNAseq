...
#python3 -m pip install -r env/testing_requirements.txt #Successfully installed
...
#   mamba_path <- "miniforge3/envs/for_reticulate"
#   # new_ldd_path <- paste(Sys.getenv("LD_LIBRARY_PATH"),
#   #                       "/home/jsmi26/miniforge3/envs/scanvi/lib",
#   #                       "/home/jsmi26/miniforge3/lib",
#   #                       sep = ":")
#   #  Sys.setenv(LD_LIBRARY_PATH=new_ldd_path)
...
ipsc_obj <- FindVariableFeatures(ipsc_obj, nfeatures = 3000)
...
dim(celltype_annots) #87870     3
# write.csv(celltype_annots, "results/day0_day50/scanvi/iPSC_motor_neuron_day0-day50_time-course_scanvi_predictions.csv", row.names = FALSE)
```
