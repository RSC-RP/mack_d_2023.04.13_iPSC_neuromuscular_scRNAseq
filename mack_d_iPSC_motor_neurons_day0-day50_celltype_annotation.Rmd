...
```{r}
dorsal_IN_expn_df <- ipsc_obj[["SCT"]]@data[dorsal_IN_markers,c(dl3_cells, ref_cells)] %>% 
  as.matrix() %>% 
  as.data.frame() %>% 
...
head(dorsal_IN_expn_df)
```

```{r fig.height=10, fig.width=15}
ggplot(dorsal_IN_expn_df, aes(x = subtype_standardized, y = value)) +
