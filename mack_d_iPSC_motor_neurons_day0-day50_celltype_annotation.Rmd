...
openssl version
# in terminal - OpenSSL 3.0.2 15 Mar 2022 (Library: OpenSSL 3.0.2 15 Mar 2022)

#List symbols in [file(s)] (a.out by default)
nm -D /usr/lib/x86_64-linux-gnu/libssl.so.3 | grep -c "3.0.2" #0 counts
nm -D /usr/lib/x86_64-linux-gnu/libssl.so.3 | grep -c "3.0.0" #998 counts

which openssl #/usr/bin/openssl
```

Fresh session - Error in py_module_import(module, convert = convert) : 
  ImportError: /usr/lib/x86_64-linux-gnu/libssl.so.3: version `OPENSSL_3.2.0' not found (required by /home/jsmi26/miniforge3/envs/scanvi/lib/python3.11/site-packages/h5py/../../.././libcurl.so.4)
Run `reticulate::py_last_error()` for details.

restart session - Error in py_module_import(module, convert = convert) : 
  ImportError: /usr/lib/x86_64-linux-gnu/libssl.so.3: version `OPENSSL_3.2.0' not found (required by /home/jsmi26/miniforge3/envs/scanvi/lib/python3.11/site-packages/h5py/../../.././libcurl.so.4)
Run `reticulate::py_last_error()` for details.
