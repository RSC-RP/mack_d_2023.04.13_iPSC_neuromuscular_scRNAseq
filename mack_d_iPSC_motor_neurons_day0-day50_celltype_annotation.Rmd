...
```{r}
ipsc_obj <- readRDS("00_archive/day0_day50/seurat/iPSC_motor_neuron_day0-day50_time-course_filtered_merged_soupX_normalized_dimred_anno_seurat_obj_v5.RDS")
...
subtype_labels <- ipsc_obj@meta.data %>% 
  mutate(subtype_labels = case_when(
    ...
    subtype_standardized == "dl3"  ~ "dorsal layer3",
    subtype_standardized == "dl4" ~ "dorsal layer4",
...
ipsc_obj@meta.data %>% 
  ...
  dplyr::count() 
  # write.csv(., "results/day0_day50/celltype_annotation_by_integrated_ref_summary_table.csv", row.names = FALSE)
```
...
Also please make text and color circle big enough for all these
three figures. please change:

progenitor to neuroglial progenitor, 
Schwann to Schwann cell,
dl3  to dorsal layer3 
dl4 to dorsal layer4
opc to oligodendrocyte progenitor
motorneuron to motor neuron
