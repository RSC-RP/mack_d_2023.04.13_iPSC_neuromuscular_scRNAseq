...
```{r}
lineages2 <- SlingshotDataSet(sce2)

names(lineages2@lineages) # 19 lineages
head(lineages2@lineages)
summary(sce$slingPseudotime_1) # pseudotime 1 to slingPseudotime_13
sce
```
