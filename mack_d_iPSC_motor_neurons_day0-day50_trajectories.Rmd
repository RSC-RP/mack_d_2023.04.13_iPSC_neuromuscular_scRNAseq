...
if( Sys.info()[["nodename"]] == "pdlposit-0" ) {
  ...
  mamba_path <- "miniforge3/envs/cellrank"
}else{
  mamba_path <- "opt/mambaforge/envs/cellrank"
}
...
current_obj <- "iPSC_MN_time-course_filtered_merged_soupX_normalized_RPCAIntegration_seurat_obj_v5.RDS"
